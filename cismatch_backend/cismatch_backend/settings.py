...
if DEBUG:
    ...
    WEBSITE_URL = 'http://89.169.0.127:80'
...
SOCIAL_AUTH_STEAM_API_KEY = '5F78EAA8FCB7C76C6A66CA9BE35C50F6'  # Получите API Key на https://steamcommunity.com/dev/apikey
SOCIAL_AUTH_STEAM_EXTRA_DATA = ['steamid', 'personaname', 'avatarfull']
STEAM_API_KEY = '5F78EAA8FCB7C76C6A66CA9BE35C50F6'
SITE_ID = 1
